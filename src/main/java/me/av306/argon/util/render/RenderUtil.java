...
public class RenderUtil
{
	...
	public static void scissorBox( int startX, int startY, int endX, int endY )
	{
		...
		int bottomY = Argon.INSTANCE.client.currentScreen.height - endY;
		double factor = Argon.INSTANCE.client.getWindow().getScaleFactor();
	...
	{
		Camera camera = Argon.INSTANCE.client.getBlockEntityRenderDispatcher().camera;
