...
import me.av306.argon.mixin.ClientPlayerEntityAccessor;
...
public class RotationUtil
{
	...
	{
		ClientPlayerEntity player = Argon.INSTANCE.client.player;
	...
	public static double getAngleToLastReportedLookVec(Vec3d vec)
	{
		...
		ClientPlayerEntityAccessor player = (ClientPlayerEntityAccessor) Argon.INSTANCE.client.player;
	...
	{
		Rotation needed = getNeededPlayerRotations( vec );
		return MathHelper.wrapDegrees(Argon.INSTANCE.client.player.getYaw() ) - needed.yaw;
	}
