...
public class CustomRenderPipelines
{
     ...
     */
    public static final RenderPipeline OVERLAY_LINES_PIPELINE = RenderPipelines.register(
    ...
    public static final RenderPipeline OVERLAY_LINE_STRIP_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder( FOGLESS_LINES_SNIPPET )
