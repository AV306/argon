...
import me.av306.argon.commands.*;
import me.av306.argon.config.FeatureConfigGroup;
import me.av306.argon.config.GeneralConfigGroup;
import me.av306.argon.config.feature.movement.FullKeyboardGroup;
import me.av306.argon.event.ClientWorldEvents;
import me.av306.argon.feature.*;
import me.av306.argon.features.*;
import me.av306.argon.features.accessibility.*;
import me.av306.argon.features.chat.*;
import me.av306.argon.features.movement.*;
import me.av306.argon.features.render.*;
import me.av306.argon.mixin.MinecraftClientAccessor;
import me.av306.argon.packets.OptInPacketPayload;
import me.av306.argon.packets.OptOutPacketPayload;
...
public enum Argon
{
    ...
    private void registerPacketHandlers()
    {
        ...
        ClientPlayNetworking.registerGlobalReceiver( OptOutPacketPayload.ID, (payload, context) ->
        {
            try
            {
                ...
                this.sendInfoMessage( "text.argon.featureblocked", payload.featureName() );
            }
        ...
        ClientPlayNetworking.registerGlobalReceiver( OptInPacketPayload.ID, (payload, context) ->
        {
            try
            {
                ...
                this.LOGGER.info( "{} blocked by server", payload.featureName() );
                this.sendInfoMessage( "text.argon.featurepermitted", payload.featureName() );
            }
            catch ( NullPointerException npe )
            {
                // Feature not present, error
    ...
    {
        //assert FabricLoader.getInstance().getModContainer( "argon" ).isPresent();
        this.modContainer = FabricLoader.getInstance().getModContainer( "argon" ).get();
        // Get version string
