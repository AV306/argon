...
import me.av306.argon.config.feature.render.ProximityRadarGroup;
import me.av306.argon.event.GameRenderEvents;
import me.av306.argon.feature.IToggleableFeature;
import me.av306.argon.util.render.RenderUtil;
import me.av306.argon.util.render.RotationUtil;
...
public class ProximityRadarFeature extends IToggleableFeature
{
    ...
    private ActionResult scanEntities( MatrixStack matrices )
    {
        ...
        if (
                this.isEnabled
                && Argon.INSTANCE.client.world != null && Argon.INSTANCE.client.player != null
        )
        {
            // GL stuff
    ...
    private void scanEntityAndRenderHighlight( MatrixStack matrices, Entity entity )
    {
        ...
        if ( ProximityRadarGroup.detectPlayers && entity instanceof PlayerEntity && entity != Argon.INSTANCE.client.player && distance < ProximityRadarGroup.playerRange )
        {
        ...
        )
        {
            ...
            if ( entity instanceof ZombifiedPiglinEntity zombifiedPiglin && !zombifiedPiglin.isAngryAt(Argon.INSTANCE.client.player ) && !ProximityRadarGroup.detectZombifiedPiglins ) return;
