...
import me.av306.argon.config.feature.render.RedReticleGroup;
...
public class RedReticleFeature extends IToggleableFeature {
    ...
    private ActionResult onStartRenderCrosshair( DrawContext drawContext, float tickDelta ) {
        if ( this.isEnabled )
        {
            ...
            HitResult hitResult = Argon.INSTANCE.client.crosshairTarget;
            ...
            if ( hitResult.getType() == HitResult.Type.ENTITY )
            {
                ...
                if ( entity.isTeammate(Argon.INSTANCE.client.player ) )
                {
                    // Friendly!
                    // Green crosshair
